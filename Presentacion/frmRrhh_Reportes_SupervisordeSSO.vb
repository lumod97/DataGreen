...
Public Class frmRrhh_Reportes_SupervisordeSSO
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim tablaResultado2 As DataTable
    Private Sub frmRrhh_Reportes_SupervisordeSSO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Sub btnConsultar_Click(sender As Object, e As EventArgs) Handles btnConsultar.Click
        ...
        encenderControlesDeEspera(barProgreso, lbl_DinResultado)
        dgv = consultarAsync()
        ...
        apagarControlesDeEspera(barProgreso, lbl_DinResultado, dgvResultado.RowCount)
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            'p.Add("@PERIODODESDE", txtDesde.Text) 'CType(dtpDesde.Value.ToString("yyyy-MM-dd"), Date))
            'p.Add("@PERIODOHASTA", txtHasta.Text) 'CType(dtpHasta.Value.ToString("yyyy-MM-dd"), Date))
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_RHH_Reportes_SupervisorSSO", p, TipoQuery.DataTable))
            Return aux
    ...
    Private Async Sub btnConsultar2_Click(sender As Object, e As EventArgs)

    End Sub

    Private Async Sub btnExportar2_Click(sender As Object, e As EventArgs)
