...
Public Class frmRrhh_Reportes_Ceses
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable

    Private Sub frmRrhh_Reportes_Ceses_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Rrhh_Reportes_Ceses", p, TipoQuery.DataTable))
            Return aux
