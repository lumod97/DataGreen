...
Public Class frmContabilidad_Reportes_IngresoBancosDetalladoFactura
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet

    Private Sub frmContabilidad_Reportes_IngresoBancosDetalladoFactura_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Contabilidad_Reportes_IngresoBancosDetalladoFactura", p, TipoQuery.DataTable))
            Return aux
