...
Public Class frmRrhh_Reportes_RefrigeriosDelPersonal
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Private Sub frmRrhh_Reportes_RefrigeriosDelPersonal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
