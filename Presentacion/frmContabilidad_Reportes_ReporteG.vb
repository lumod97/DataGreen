...
Public Class frmContabilidad_Reportes_ReporteG
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable


    Private Sub frmContabilidad_Reportes_ReporteG_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Contabilidad_Reportes_ReporteG", p, TipoQuery.DataTable))
            Return aux
