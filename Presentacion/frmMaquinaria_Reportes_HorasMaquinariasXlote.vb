...
Public Class frmMaquinaria_Reportes_HorasMaquinariasXlote
    ...
    Private Sub frmMaquinaria_Reportes_HorasMaquinariasXlote_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        aplicarTema(Me)
    ...
    Private Async Function ProcesarAsync() As Task(Of DataTable)
        ...
        Try
            ...
            r = Await Task.Run(Function() doItBaby("sp_Dg_Maquinaria_Reportes_HorasMaquinariasXlote2", p, TipoQuery.DataTable))
