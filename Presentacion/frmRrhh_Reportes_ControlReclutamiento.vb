...
Public Class frmRrhh_Reportes_ControlReclutamiento
    Dim dsParaCombos As DataSet = New DataSet
    Dim dtResultado As DataTable
    Dim arrayDeParametros As String
    Private Sub frmRrhh_Reportes_ControlReclutamiento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Rrhh_Control_Reclutamiento", p, TipoQuery.DataTable))
            Return aux
