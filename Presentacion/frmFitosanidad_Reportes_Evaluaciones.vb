...
Public Class frmFitosanidad_Reportes_Evaluaciones
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet

    Private Sub frmFitosanidad_Reportes_Evaluaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub obtenerDataParaCombos()
        ...
        dsDataParaCombo.Tables.Add(doItBaby("sp_Ev_ObtenerTiposEvaluaciones", Nothing, TipoQuery.DataTable))
        dsDataParaCombo.Tables.Add(doItBaby("sp_Ev_ObtenerLotes", Nothing, TipoQuery.DataTable))
    End Sub
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            p.Add("@IdLote", cboLote.SelectedValue)
            arrayDeParametros = obtenerCadenaParametros(p)
            aux = Await Task.Run(Function() doItBaby("Evolet.Dbo.sp_Reportes_PlagasEnfermedades", p, TipoQuery.DataTable))
            Return aux
