...
Public Class frmProduccion_Reportes_TablasCampanasCultivos

    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet

    Private Sub frmProduccion_Reportes_TablaCampanasCultivos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            arrayDeParametros = ""
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Produccion_Reportes_TablaCampanasCultivos", Nothing, TipoQuery.DataTable))
            Return aux
