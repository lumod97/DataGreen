...
Public Class frmAlmacenes_Reportes_RequerimientosInternos
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet

    Private Sub frmAlmacenes_Reportes_RequerimientosInternos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tlpPrincipal.Visible = False
        Me.WindowState = FormWindowState.Maximized
        obtenerDataParaCombos()
        cargarCombo(cboArea, dsDataParaCombo.Tables(0), "", True)
        cargarCombo(cboProducto, dsDataParaCombo.Tables(1), "", False)
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Almacenes_Reportes_RequerimientosInternos", p, TipoQuery.DataTable))
            Return aux
    ...
    Private Sub obtenerDataParaCombos()
        ...
        dsDataParaCombo.Tables.Add(doItBaby("sp_Dg_ObtenerAreas", Nothing, TipoQuery.DataTable))
        dsDataParaCombo.Tables.Add(doItBaby("sp_Dg_ObtenerProductos", Nothing, TipoQuery.DataTable))
    End Sub
