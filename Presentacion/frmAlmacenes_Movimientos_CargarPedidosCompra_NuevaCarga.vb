...
Public Class frmAlmacenes_Movimientos_CargarPedidosCompra_NuevaCarga
    'Dim dsMetaDatos As New DataSet
    Dim dtTablaExcel As New DataTable
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable

    Private Sub frmAlmacenes_Movimientos_CargarPedidosCompra_NuevaCarga_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        aplicarTema(Me)
    End Sub
