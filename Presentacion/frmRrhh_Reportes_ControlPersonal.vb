...
Public Class frmRrhh_Reportes_ControlPersonal
    ...
    Private Sub frmRrhh_Reportes_ControlPersonal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cargarCombo(cboEstado, dsParaCombos.Tables(1), 0, 2)
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            p.Add("@Estado", cboEstado.SelectedValue)
            arrayDeParametros = obtenerCadenaParametros(p)
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Rrhh_Reprtes_ControlPersonal", p, TipoQuery.DataTable))
            Return aux
