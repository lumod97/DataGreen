...
Public Class frmPacking_Reportes_SeguimientoPlanComercial
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Packing_Reportes_SeguimientoPlanComercial", p, TipoQuery.DataTable))
            Return aux
