...
Public Class frmRrhh_Reportes_Amonestaciones
    Dim dsParaCombos As DataSet = New DataSet
    Dim dtResultado As DataTable
    Dim arrayDeParametros As String

    Private Sub frmRrhh_Reportes_Amonestaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Rrhh_Reportes_Amonestaciones", p, TipoQuery.DataTable))
            Return aux
