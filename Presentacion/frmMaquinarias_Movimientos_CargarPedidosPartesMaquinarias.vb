...
Public Class frmMaquinarias_Movimientos_CargarPedidosPartesMaquinarias
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable

    Private Sub frmMaquinarias_Movimientos_CargarPedidosPartesMaquinarias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Maquinarias_Movimientos_CargarPedidosMaquinaria_Listar", p, TipoQuery.DataTable))
            Return aux
    ...
    Private Sub btnNuevos_Click(sender As Object, e As EventArgs) Handles btnNuevos.Click
        Dim v As New frmMaquinaria_Reportes_HorasMaquinariasXlote
