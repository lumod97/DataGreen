...
Public Class frmAlmacenes_Movimientos_CargarPedidosCompra
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable

    Private Sub frmAlmacenes_Movimientos_CargarPedidosCompra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Almacenes_Movimientos_CargarPedidosCompra_ListarPedidos", p, TipoQuery.DataTable))
            Return aux
    ...
    Private Sub btnNuevos_Click(sender As Object, e As EventArgs) Handles btnNuevos.Click
        Dim v As New frmAlmacenes_Movimientos_CargarPedidosCompra_NuevaCarga
