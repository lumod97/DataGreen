...
Public Class frmPacking_Reportes_EficienciasPersonal
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            p.Add("@Fecha", CType(pkrDia.Value.ToString("yyyy-MM-dd"), DateTime))
            arrayDeParametros = obtenerCadenaParametros(p)
            'aux = Await Task.Run(Function() doItBaby("sp_Dg_Packing_Reportes_EficienciasPersonal", p, TipoQuery.DataTable))
            If radCultivoVariedad.Checked Then
                aux = Await Task.Run(Function() doItBaby("sp_Dg_Packing_Reportes_EficienciasPersonalXLineaLaborVariedad", p, TipoQuery.DataTable))
            ElseIf radConAjuste.Checked Then
                aux = Await Task.Run(Function() doItBaby("sp_Dg_Packing_Reportes_EficienciasPersonal", p, TipoQuery.DataTable))
            End If
            Return aux
