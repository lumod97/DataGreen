...
Public Class frmRrhh_Reportes_AntecedentesInternos
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable


    Private Sub frmRrhh_Reportes_AntecedentesInternos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            p.Add("@Personas", IIf(radTodos.Checked, "********", txtCodigo.Text))
            arrayDeParametros = obtenerCadenaParametros(p)
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Rrhh_Reportes_AntecedentesInternos", p, TipoQuery.DataTable))
            Return aux
