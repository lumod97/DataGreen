...
Public Class frmPacking_Reportes_ConsultarCodigos

    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable

    Private Sub frmPacking_Reportes_ConsultarCodigos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            p.Add("@Codigo", txtCodigo.Text)
            arrayDeParametros = obtenerCadenaParametros(p)
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Packing_Reportes_ConsultarCodigo", p, TipoQuery.DataTable))
            Return aux
    ...
    Private Sub txtCodigo_KeyDown(sender As Object, e As KeyEventArgs) Handles txtCodigo.KeyUp
