...
Public Class frmRrhh_Reportes_ControlIntermitencia
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet
    Private Sub frmRrhh_Reportes_ControlIntermitencia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Private Async Sub btnConsultar_Click(sender As Object, e As EventArgs)
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            arrayDeParametros = ""
            aux = Await Task.Run(Function() doItBaby("sp_Dg_RHH_Reportes_ControlIntermitencia", Nothing, TipoQuery.DataTable))
            Return aux
    ...
    Private Async Sub btnConsultar_Click_1(sender As Object, e As EventArgs) Handles btnConsultar.Click
