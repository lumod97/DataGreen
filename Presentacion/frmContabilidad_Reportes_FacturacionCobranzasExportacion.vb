...
Public Class frmContabilidad_Reportes_FacturacionCobranzasExportacion
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet

    Private Sub frmContabilidad_Reportes_FacturacionCobranzasExportacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Contabilidad_Reportes_FacturacionCobranzasExportacion", p, TipoQuery.DataTable))
            Return aux
