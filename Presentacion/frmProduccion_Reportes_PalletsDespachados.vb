...
Public Class frmProduccion_Reportes_PalletsDespachados
    Dim arrayDeParametros As String = String.Empty
    Dim tablaResultado As DataTable
    Dim dsDataParaCombo As DataSet

    Private Sub frmProduccion_Reportes_PalletsDespachados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Async Function consultarAsync() As Task(Of DataTable)
        Try
            ...
            aux = Await Task.Run(Function() doItBaby("sp_Dg_Produccion_Reportes_PalletsDespachados", p, TipoQuery.DataTable))
            Return aux
